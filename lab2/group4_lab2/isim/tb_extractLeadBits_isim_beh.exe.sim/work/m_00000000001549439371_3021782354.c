...
LAB18:    t201 = (t0 + 1768);
    xsi_vlogvar_assign_value(t201, t4, 0, 0, 3);
    ...
    t7 = *((char **)t6);
    memset(t4, 0, 8);
    xsi_vlog_unsigned_lshift(t4, 11, t3, 11, t7, 3);
    t9 = (t0 + 1928);
    xsi_vlogvar_assign_value(t9, t4, 0, 0, 11);
    goto LAB2;
...
LAB30:    memcpy(t32, t60, 8);

LAB31:    goto LAB13;

LAB14:    xsi_vlog_unsigned_bit_combine(t4, 3, t27, 3, t32, 3);
    goto LAB18;
...
LAB43:    memcpy(t60, t88, 8);

LAB44:    goto LAB26;

LAB27:    xsi_vlog_unsigned_bit_combine(t32, 3, t55, 3, t60, 3);
    goto LAB31;

LAB29:    memcpy(t32, t55, 8);
    goto LAB31;
...
LAB56:    memcpy(t88, t116, 8);

LAB57:    goto LAB39;

LAB40:    xsi_vlog_unsigned_bit_combine(t60, 3, t83, 3, t88, 3);
    goto LAB44;

LAB42:    memcpy(t60, t83, 8);
    goto LAB44;
...
LAB67:    if (*((unsigned int *)t117) > 0)
        goto LAB68;

LAB69:    memcpy(t116, t144, 8);

LAB70:    goto LAB52;

LAB53:    xsi_vlog_unsigned_bit_combine(t88, 3, t111, 3, t116, 3);
    goto LAB57;

LAB55:    memcpy(t88, t111, 8);
    goto LAB57;

LAB58:    *((unsigned int *)t117) = 1;
    goto LAB61;
...
LAB80:    if (*((unsigned int *)t145) > 0)
        goto LAB81;

LAB82:    memcpy(t144, t172, 8);

LAB83:    goto LAB65;

LAB66:    xsi_vlog_unsigned_bit_combine(t116, 3, t139, 3, t144, 3);
    goto LAB70;

LAB68:    memcpy(t116, t139, 8);
    goto LAB70;
...
LAB95:    memcpy(t172, t200, 8);

LAB96:    goto LAB78;

LAB79:    xsi_vlog_unsigned_bit_combine(t144, 3, t167, 3, t172, 3);
    goto LAB83;

LAB81:    memcpy(t144, t167, 8);
    goto LAB83;

LAB84:    *((unsigned int *)t173) = 1;
    goto LAB87;
...
LAB92:    xsi_vlog_unsigned_bit_combine(t172, 3, t195, 3, t200, 3);
    goto LAB96;

LAB94:    memcpy(t172, t195, 8);
    goto LAB96;
...
extern void work_m_00000000001549439371_3021782354_init()
{
	static char *pe[] = {(void *)Always_110_0,(void *)Cont_123_1,(void *)Cont_124_2,(void *)Cont_125_3,(void *)Cont_126_4,(void *)Cont_127_5};
	xsi_register_didat("work_m_00000000001549439371_3021782354", "isim/tb_extractLeadBits_isim_beh.exe.sim/work/m_00000000001549439371_3021782354.didat");
